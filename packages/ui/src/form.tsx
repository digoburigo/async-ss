...
function FormDescription({ className, ...props }: React.ComponentProps<"p">) {
  ...
  return (
    <p
      className={cn(
        "absolute bottom-0 translate-y-full transform pt-1 text-muted-foreground text-sm",
        className
      )}
  ...
  return (
    <p
      className={cn(
        ...
        "absolute bottom-0 translate-y-full transform pt-1 font-medium text-destructive text-sm",
        className
      )}
