...
export function TimerToast({
  ...
  return (
    <div
      className="group pointer-events-auto relative max-h-[200px] min-h-[48px] w-[356px] overflow-hidden rounded-md border bg-background shadow-lg transition-shadow hover:shadow-xl"
    ...
    >
      ...
      <div className="relative flex items-start justify-between p-3 pr-10">
        ...
        <Button
          className="absolute top-2 right-2 size-5 flex-shrink-0 p-0 text-foreground/50 opacity-0 transition-opacity hover:text-foreground group-hover:opacity-100"
          onClick={onDismiss}
          size="sm"
          variant="ghost"
        >
