...
const comboboxItemVariants = cva(
  "text-foreground relative mx-1 flex h-[28px] items-center rounded-sm px-2 text-sm outline-none select-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    defaultVariants: {
      interactive: true,
    },
    variants: {
      interactive: {
        false: "",
        true: "hover:bg-accent hover:text-accent-foreground data-[active-item=true]:bg-accent data-[active-item=true]:text-accent-foreground cursor-pointer transition-colors",
      },
    },
  },
);
