...
import { ScrollArea } from "@acme/ui/base-ui/scroll-area";
...
function ComboboxPopup({
  ...
  return (
    <ComboboxPrimitive.Portal>
      ...
      >
        <span className="bg-popover relative flex max-h-full origin-(--transform-origin) rounded-md border bg-clip-padding transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-lg has-data-starting-style:scale-98 has-data-starting-style:opacity-0 dark:not-in-data-[slot=group]:bg-clip-border">
