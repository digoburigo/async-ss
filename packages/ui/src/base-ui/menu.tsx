  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        <span
          className={cn(
            "bg-popover relative flex origin-(--transform-origin) rounded-md border bg-clip-padding shadow-lg transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] has-data-starting-style:scale-98 has-data-starting-style:opacity-0 dark:bg-clip-border dark:before:shadow-[0_-1px_--theme(--color-white/8%)]",
            className,
          )}
        >
          <MenuPrimitive.Popup
