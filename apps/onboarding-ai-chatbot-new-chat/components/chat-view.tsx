    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 404 && retryCount < 3) {
          console.log("[v0] Session not found, retrying in 500ms... (attempt", retryCount + 1, ")")
          setTimeout(() => {
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <Alert variant="destructive" className="max-w-md">
          ...
          <AlertDescription className="mt-2">
            ...
            <Button variant="outline" size="sm" className="mt-4 w-full bg-transparent" onClick={handleBack}>
