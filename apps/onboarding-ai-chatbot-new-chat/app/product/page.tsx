			...
			<header className="border-b border-gray-200 bg-white sticky top-0 z-50 backdrop-blur-sm bg-white/90">
				<div className="container mx-auto px-4 py-4 flex items-center justify-between max-w-7xl">
					...
					<Link href="/auth/login">
						<Button
							variant="outline"
							className="border-[#5B9AAD] text-[#5B9AAD] hover:bg-[#5B9AAD]/10 bg-transparent"
						>
							Entrar
						</Button>
					</Link>
				...
				<div className="container mx-auto px-4 max-w-7xl">
					<div className="grid grid-cols-2 md:grid-cols-4 gap-8">
						<div className="text-center">
							<div className="text-4xl md:text-5xl font-bold text-[#5B9AAD] mb-2">
								50%
							</div>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<div className="relative">
							...
							<div className="relative z-10">
								...
								{/* Keyboard base */}
								<div
									className="relative h-3 bg-gray-300 rounded-b-xl mx-auto"
									style={{ width: "110%" }}
								/>
								<div
									className="relative h-1 bg-gray-400 rounded-b-2xl mx-auto shadow-lg"
									style={{ width: "120%" }}
								/>
							</div>
