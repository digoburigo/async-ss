...
export async function POST(request: NextRequest) {
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: "Failed to create column", details: error.message }, { status: 500 })
    }
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: "Failed to update column", details: error.message }, { status: 500 })
    }
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: "Failed to delete column", details: error.message }, { status: 500 })
    }
