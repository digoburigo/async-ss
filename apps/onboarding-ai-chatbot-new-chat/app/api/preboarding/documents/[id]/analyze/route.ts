  ...
  try {
    ...
    if (doc.file_url) {
      try {
        ...
        documentContent =
          "[Não foi possível extrair o texto do documento. Análise baseada nas informações disponíveis.]";
      }
    }
...
${hasContent ? documentContent.substring(0, 15_000) : "O conteúdo do documento não pôde ser extraído automaticamente. Por favor, forneça uma análise geral baseada no tipo de documento e nas informações do candidato disponíveis."}
