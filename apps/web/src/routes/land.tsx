    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#5B9AAD] via-[#3A7A8A] to-[#1E3A4C] py-20 text-white">
      ...
      <div className="container relative mx-auto max-w-7xl px-4">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-balance font-bold text-3xl md:text-5xl">
            Entre em Contato
          </h2>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="mb-1 font-semibold text-lg">Email</h4>
                  <a
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="mb-1 font-semibold text-lg">Telefone</h4>
                  <a
                    className="text-base opacity-90 transition-opacity hover:opacity-100"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="mb-1 font-semibold text-lg">Endereço</h4>
            ...
            <div className="pt-6">
              <h4 className="mb-4 font-semibold text-lg">Redes Sociais</h4>
