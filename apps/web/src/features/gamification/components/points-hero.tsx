        ...
        <div className="flex flex-col items-center gap-6 md:flex-row md:justify-between">
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              ...
              <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-orange-500 shadow-amber-500/30 shadow-lg">
                <Trophy className="h-12 w-12 text-white drop-shadow-lg" />
              </div>
              <div className="absolute -right-1 -bottom-1 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-purple-600 font-bold text-white text-xs shadow-lg">
                {level}
              </div>
            </div>
            ...
            <div className="text-center md:text-left">
              ...
              <p className="bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text font-black text-5xl text-transparent tabular-nums">
